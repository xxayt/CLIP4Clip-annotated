...
- MSRVTT (Training-9K)
  - text to video retrieval
    ...
    | :---------: | :------------: | :--: | :--: | :--: | :--: |
    | meanP | 42.6 (ep1) / 43.1 | 68.9 / 70.4 | 80.4 / 80.8 | 2 / 2 | 16.7 / 16.2 |
    | seqLSTM | 42.2 (ep2) / 42.5 | 70.1 / 70.8 | 80.7 / 80.7 | 2 / 2 | 16.4 / 16.7 |
    | seqTransf | 43.0 (ep2) / **44.5** | 70.2 / 71.4 | 81.4 / **81.6** | 2 / 2 | 15.0 / 15.3 |
    | tightTransf | 39.2 (ep4) / 40.2 | 69.8 / **71.5** | 80.5 / 80.5 | 2 / 2 | 13.5 / **13.4** |
...
- MSVD
  - text to video retrieval
    |   Methods   | R@1$\uparrow$ | R@5$\uparrow$ | R@10$\uparrow$ | MdR$\downarrow$  | MnR$\downarrow$ |
    | :---------: | :------------: | :--: | :--: | :--: | :--: |
    | meanP | 46.0 (ep1) / **46.2** | 74.4 / **76.1** | 83.9 / **84.6** | 2 / 2 | 10.2 / **10.0** |
    | seqLSTM | 45.7 / **46.2** | 74.4 / 75.3 | 83.7 / 84.5 | 2 / 2 | 10.3 / 10.2 |
    | seqTransf |  / 45.2 |  / 75.5 |  / 84.3 | 2 / 2 |  / 10.3 |
    | tightTransf |  / 40.0 |  / 71.5 |  / 82.1 | 2 / 2 |  / 13.3 |

  - video to text retrieval
    |   Methods   | R@1$\uparrow$ | R@5$\uparrow$ | R@10$\uparrow$ | MdR$\downarrow$  | MnR$\downarrow$ |
    | :---------: | :------------: | :--: | :--: | :--: | :--: |
    | meanP | 61.8 / 56.6 | 84.9 / 79.7 | 91.0 / 84.3 | 1 / 1 | 4.5 / 7.6 |
    | seqLSTM | 57.5 / 52.5 | 79.9 / 74.0 | 85.0 / 78.1 | 1 / 1 | 7.9 / 14.7 |
    | seqTransf |  / 62.0 |  / 87.3 |  / 92.6 | 1 / 1 |  / 4.3 |
    | tightTransf |  / 54.3 |  / 85.3 |  / 91.0 | 1 / 1 |  / 6.0 |
